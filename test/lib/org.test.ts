...
import { listProjects, setNotificationPreferences, listTargets } from '../../src/lib';
...
describe('listTargets', () => {
  ...
  it('list the targets in a given Org with filter - mock', async () => {
    ...
    const res = await listTargets(requestManager, ORG_ID, {origin: "github-enterprise"});
    expect(req).toBeCalledWith({"body": undefined, "url": "https://api.dev.snyk.io/rest/orgs/74e2f385-a54f-491e-9034-76c53e72927a/targets?version=2022-09-15%7Ebeta&origin=github-enterprise", "useRESTApi": true, "verb": "get"})
    expect(res).toMatchSnapshot()   
  }, 5000);
  ...
  it('list the targets in a given Org with pagination - mock', async () => {
    ...
    req.mockResolvedValueOnce({
      ...
      data: 
      {
        ...
        links: {
          "first": "https://api.dev.snyk.io/rest/orgs/74e2f385-a54f-491e-9034-76c53e72927a/targets?version=2022-09-15~beta",
          "last": "https://api.dev.snyk.io/rest/orgs/74e2f385-a54f-491e-9034-76c53e72927a/targets?version=2022-09-15~betapage=2",
          "next": "https://api.dev.snyk.io/rest/orgs/74e2f385-a54f-491e-9034-76c53e72927a/targets?version=2022-09-15~betapage=2",
          "self": "https://api.dev.snyk.io/rest/orgs/74e2f385-a54f-491e-9034-76c53e72927a/targets?version=2022-09-15~beta"
        }
      }
    }).mockResolvedValueOnce(
      {
        ...
        data: 
        {
          ...
          links: {
            "first": "https://api.dev.snyk.io/rest/orgs/74e2f385-a54f-491e-9034-76c53e72927a/targets?version=2022-09-15~beta",
            "last": "https://api.dev.snyk.io/rest/orgs/74e2f385-a54f-491e-9034-76c53e72927a/targets?version=2022-09-15~betapage=2",
            "self": "https://api.dev.snyk.io/rest/orgs/74e2f385-a54f-491e-9034-76c53e72927a/targets?version=2022-09-15~betapage=2"
          }
        }
      }
    )
  ...
  it('Error if the requests fails', async () => {
    ...
    expect(async () => {await listTargets(requestManager, ORG_ID)}).rejects.toThrowError('Expected a 200 response, instead received: {"data":{},"status":500}')
