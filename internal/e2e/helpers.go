...
func LoadE2EConfig() *E2EConfig {
	cfg := &E2EConfig{
		...
		GitHubTestRepos: os.Getenv("GITHUB_TEST_REPOS"),
...
type IntegrationTestConfig struct {
	...
	// Extra command-line arguments for the sync command
	ExtraSyncArgs []string

	// Extra command-line arguments for the import:data command
	ExtraImportDataArgs []string
...
func RunImportDataTest(t *testing.T, ctx context.Context, cfg *E2EConfig, intCfg IntegrationTestConfig, testDir string) string {
	...
	importArgs = append(importArgs, intCfg.ExtraImportDataArgs...)
	os.Args = importArgs
...
func RunSyncTest(t *testing.T, ctx context.Context, cfg *E2EConfig, intCfg IntegrationTestConfig, testDir string) {
	...
	args = append(args, intCfg.ExtraSyncArgs...)
