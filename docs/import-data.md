...
2. You will need to have the organizations data in json as an input to this command to help map Snyk organization IDs and Integration Ids that must be used during import against individual targets to be imported. The following format is required:
  ...
  - Integrations can be listed via [Snyk Integrations API](https://docs.snyk.io/snyk-api/reference/integrations-v1)
  - All organization IDs can be found by listing all organizations a group admin belongs to via [Snyk Organizations API](https://docs.snyk.io/snyk-api/reference/groups-v1)
