...
This util helps generate data needed to mirror the Github.com / Github Enterprise / Gitlab / Bitbucket Server organization/group/project structure in Snyk.
This is an opinionated util and will assume every organization/group/project in Github.com / Github Enterprise / Gitlab / Bitbucket Server should become an organization in Snyk. If this is not what you are looking for, please look at using the [Organizations API](https://snyk.docs.apiary.io/#reference/groups/organizations-in-a-group/create-a-new-organization-in-a-group) directly to create the structure you need.
